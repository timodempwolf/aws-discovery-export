...
DEPRECATED_OR_DISALLOWED = {
    ...
    "mediaconvert": ["ListJobTemplates", "ListJobs", "ListPresets", "ListQueues"],
...
RESULT_IGNORE_ERRORS = {
    ...
    "ec2": {
        ...
        "DescribeReservedInstancesListings": "not authorized to use the requested product. "
    ...
    "mturk": {
        "GetAccountBalance": "Your AWS account must be linked to your "
        + "Amazon Mechanical Turk Account",
        "ListBonusPayments": "Your AWS account must be linked to your "
        + "Amazon Mechanical Turk Account",
        "ListHITs": "Your AWS account must be linked to your "
        + "Amazon Mechanical Turk Account",
        "ListQualificationRequests": "Your AWS account must be linked to your "
        + "Amazon Mechanical Turk Account",
        "ListReviewableHITs": "Your AWS account must be linked to your "
        + "Amazon Mechanical Turk Account",
        "ListWorkerBlocks": "Your AWS account must be linked to your "
        + "Amazon Mechanical Turk Account",
    },
    "organizations": {
...
PARAMETERS = {
    ...
    "elasticbeanstalk": {
        "ListPlatformVersions": {
            "Filters": [{"Operator": "=", "Type": "PlatformOwner", "Values": ["self"]}]
        }
    },
    "emr": {
        "ListClusters": {
